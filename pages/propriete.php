...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5 mx-auto ">
            ...
            <div class="col-md-4 my-2">
                <img src="/images/construction/4.jpeg" class="img-fluid" alt="Image banniere" style="width:100%; height:100%">
            </div>
            <div class="col-md-4 my-2">
                <img src="/images/construction/5.jpeg" class="img-fluid" alt="Image banniere" style="width:100%; height:100%">
            </div>
            <div class="col-md-4 my-2">
                <img src="/images/construction/2.jpeg" class="img-fluid" alt="Image banniere" style="width:100%; height:100%">
            </div>
        </div>
        <div class="row mt-5 mx-auto ">
            <h1 class="text-center pb-4">Vente de terrain</h1>
            <div class="col-md-4 my-2">
                <img src="/images/terrain/1.jpeg" class="img-fluid" alt="Image banniere" style="width:100%; height:100%">
            </div>
            <div class="col-md-4 my-2">
                <img src="/images/terrain/2.jpeg" class="img-fluid" alt="Image banniere" style="width:100%; height:100%">
            </div>
            <div class="col-md-4 my-2">
                <img src="/images/terrain/3.jpeg" class="img-fluid" alt="Image banniere" style="width:100%; height:100%">
            </div>
        </div>
    </div>
    <!-- Footer -->
