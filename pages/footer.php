        ...
        <div class="row footer-content align-items-center">
            ...
            <div class="col-sm-12 col-md-2 col-lg-2">
                <div class="row">
                    <h5>Nous suivre !</h5>
                    <div class="col-md-12">
                        <a class="btn mx-1" title="facebook" href="https://web.facebook.com/silvergodimmo"><i class="rs-js fab fa-facebook-f"> Facebook</i> </a>
                    </div>
                    <div class="col-md-12">
                        <a class="btn mx-1" title="instagram" href="https://www.instagram.com/silver__gold__immo/"><i class="rs-js fab fa-instagram"> Instagram</i></a>
                    </div>
                    <div class="col-md-12">
